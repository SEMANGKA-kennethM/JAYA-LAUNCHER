	...
	for(int z=1;z<=5;z++){
		...
		for(int a=1;a<=3;a++){
			...
			for(int b=1;b<=3;b++){
				...
				//	printf("%d %d\n",a ,b );
					if((arrXO[a-1][b]==arrXO[a][b] && arrXO[a+1][b]==0)|| (arrXO[a][b]==arrXO[a+1][b] && arrXO[a-1][b]==0)){
					//	printf("First\n");
					//	getch();
						if(arrXO[a-1][b]==0){
							arrXO[a-1][b]=2;
					...
					else if((arrXO[a][b-1]==arrXO[a][b] && arrXO[a][b+1]==0) || (arrXO[a][b]==arrXO[a][b+1] && arrXO[a][b-1]==0)){
					//	printf("Second %d %d\n", a,b);
						if(arrXO[a][b-1]==0){
							printXO();
					//		printf("first\n\n");
					...
					else if((arrXO[a-1][b-1]==arrXO[a][b] && arrXO[a+1][b+1]==0) || (arrXO[a][b]==arrXO[a+1][b+1] && arrXO[a-1][b-1]==0)){
					//	printf("third\n");
					//	getch();
						if(arrXO[a-1][b-1]==0){
						//	printf("first\n");
